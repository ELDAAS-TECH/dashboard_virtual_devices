      ...
      <Stack sx={{ width: "33.33%", overflowX: "scroll" }} textAlign="center">
        ...
        <Table size="small">
          ...
          <TableRow>
            ...
            <TableCell>{datafordevicetable.hh_fw_revision}</TableCell>
          </TableRow>
          <TableRow>
            <TableCell variant="head" sx={{ backgroundColor: "#f3f3f3" }}>
              Landline
      ...
      <Stack sx={{ width: "33.33%", overflowX: "scroll" }} textAlign="center">
        ...
        <Table size="medium" align="center">
          ...
          <TableRow>
            ...
            <TableCell>
              {datafordevicetable.b_solar_lvl !== undefined
                ? datafordevicetable.b_solar_lvl.toString()
                : "N/A"}
            </TableCell>
          </TableRow>
          ...
          <TableRow>
            ...
            <TableCell> {datafordevicetable.beeacon_temperature_value}</TableCell>
          </TableRow>
          ...
          <TableRow>
            ...
            <TableCell> {datafordevicetable.b_fw_revision}</TableCell>
          </TableRow>
        </Table>
      </Stack>
      <Stack sx={{ width: "33.33%", overflowX: "scroll" }} textAlign="center">
        ...
        <Table size="small">
          ...
          <TableRow>
            ...
            <TableCell>{datafordevicetable.g_fw_revision}</TableCell>
          </TableRow>
        </Table>
      </Stack>
    </div>
