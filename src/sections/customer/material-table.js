...
const Materialtable = ({ onSelectedSubValuesChange }) => {
  ...
  // console.log(checkedRow, "chekedRow");
  ...
  const handleSelectAllClick = () => {
    ...
    const updatedRows = selectAll ? [] : data.map((user) => ({ sub: user.sub }));
  ...
  const getHoverBackgroundColor = (user) => {
    const backgroundColor = rowBackgroundColors[user.sub];

    if (typeof backgroundColor === "string") {
      // Return a different background color for hover state
      // For example, you can lighten or darken the existing color
      // Here, I'll provide a lighter shade as an example
      const hoverBackgroundColor = lighten(0.2, backgroundColor);
      return hoverBackgroundColor;
    } else {
      // If backgroundColor is not a string, return a default color or handle the situation accordingly
      return "inherit"; // or provide a default color
    }
  };

  //applying background color to the entire row
              ...
              <Box sx={{}}>
                ...
                <Table size="small" align="center">
                  ...
                  <TableRow>
                    ...
                    <TableCell>
                      {dropdownData.b_solar_lvl !== undefined
                        ? dropdownData.b_solar_lvl.toString()
                        : "N/A"}
                    </TableCell>
                  </TableRow>
              ...
              <Box sx={{}}>
                ...
                <Table size="small">
                  ...
                  <TableRow>
                    ...
                    <TableCell>{dropdownData.g_fw_ver}</TableCell>
                  </TableRow>
                </Table>
              </Box>
            </Stack>
  ...
  const table = useMaterialReactTable({
    ...
    muiTableBodyRowProps: ({ row }) => ({
      ...
      //     cursor: "pointer",
      //     "&:hover": {
      //       backgroundColor: getHoverBackgroundColor(row.original),
      //     },
      //   },
      sx: {
  ...
  return !loading ? (
    ...
    <Stack sx={{ justifyContent: "center", alignItems: "center", pt: "200px" }}>
      <CircularProgress />
    </Stack>
  );
};
